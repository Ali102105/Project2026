        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="geheugen" type="number" min="0" max="4000"
                        class="form-control <?= isset($data['errors']['geheugen']) ? 'is-invalid' : ''; ?>"
                        id="geheugen" value="<?= $_POST['geheugen'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="besturingssysteem" type="text"
                        ...
                        id="besturingssysteem" value="<?= $_POST['besturingssysteem'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="schermgrootte" type="number" min="0" max="10" step="0.01"
                        class="form-control <?= isset($data['errors']['schermgrootte']) ? 'is-invalid' : ''; ?>"
                        id="schermgrootte" value="<?= $_POST['schermgrootte'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="megapixels" type="number" min="0" max="200"
                        class="form-control <?= isset($data['errors']['megapixels']) ? 'is-invalid' : ''; ?>"
                        id="megapixels" value="<?= $_POST['megapixels'] ?? ''; ?>">
